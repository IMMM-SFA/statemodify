...
def modify_single_xbm_iwr(mu_0: float,
    ...
    # load data fit to all 5 sites
    dry_state_means = np.loadtxt(pkg_resources.resource_filename("statemodify", "data/dry_state_means.txt"))
    wet_state_means = np.loadtxt(pkg_resources.resource_filename("statemodify", "data/wet_state_means.txt"))
    covariance_matrix_dry = np.loadtxt(pkg_resources.resource_filename("statemodify", "data/covariance_matrix_dry.txt"))
    covariance_matrix_wet = np.loadtxt(pkg_resources.resource_filename("statemodify", "data/covariance_matrix_wet.txt"))
    transition_matrix = np.loadtxt(pkg_resources.resource_filename("statemodify", "data/transition_matrix.txt"))

    AnnualQ_s = generate_flows(dry_state_means=dry_state_means,
